...
extern CCDictionary* ccFileUtils_dictionaryWithMemoryThreadSafe(const char *fileData, int size);
...
CCDictionary* CCDictionary::createWithMemoryThreadSafe(const char *fileData, int size)
{
    return ccFileUtils_dictionaryWithMemoryThreadSafe(fileData, size);
}
